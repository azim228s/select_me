...
import 'package:select_me/ui/merchants/merchants.dart';
...
class BottomNavBarScreenMarket extends StatefulWidget {
  @override
  _BottomNavBarScreenMarketState createState() => _BottomNavBarScreenMarketState();
}

class _BottomNavBarScreenMarketState extends State<BottomNavBarScreenMarket> {
  // Properties & Variables needed

  int currentTab = 0; // to keep track of active tab index
  final List<Widget> screens = [
    MerchantScreen(),
    StorageScreen(isMerchant: false),
    ProfileScreen(
      isMerchant: false,
    ),
